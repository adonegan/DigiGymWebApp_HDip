...
namespace DigiGymWebApp_HDip.Data.Migrations
{
    ...
    [Migration("20240728171036_AddMessageConversationsNotificationModelRels")]
    partial class AddMessageConversationsNotificationModelRels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigiGymWebApp_HDip.Models.Conversation", b =>
                {
            ...
            modelBuilder.Entity("DigiGymWebApp_HDip.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("DigiGymWebApp_HDip.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("DigiGymWebApp_HDip.Models.Conversation", b =>
                {
                    b.HasOne("DigiGymWebApp_HDip.Models.ApplicationUser", "Client")
                        .WithMany("ClientConversations")
                        .HasForeignKey("ClientID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DigiGymWebApp_HDip.Models.ApplicationUser", "Trainer")
            ...
            modelBuilder.Entity("DigiGymWebApp_HDip.Models.Message", b =>
                {
                    b.HasOne("DigiGymWebApp_HDip.Models.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigiGymWebApp_HDip.Models.ApplicationUser", "Receiver")
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("ReceiverID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DigiGymWebApp_HDip.Models.ApplicationUser", "Sender")
